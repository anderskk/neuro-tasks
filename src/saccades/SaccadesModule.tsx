...
function SaccadesModule() {
  ...
  const [storedGameConfig, setGameConfig] = useLocalStorageState<GameConfig | Partial<GameConfig>>(
    'saccadesConfig',
    {
      defaultValue: () => initGameConfig
    }
  )
  ...
  const onRepetitionChange = (num: number) => setGameConfig(({
    ...gameConfig,
  ...
  const onBlinkDurationChange = (num: number) => setGameConfig(({
    ...gameConfig,
    [gameConfig.orientation]: {
      ...gameConfig[gameConfig.orientation],
      blinkDuration: num
  ...
  const onPauseDurationChange = (num: number) => setGameConfig(({
    ...gameConfig,
    [gameConfig.orientation]: {
      ...gameConfig[gameConfig.orientation],
      pauseDuration: num
